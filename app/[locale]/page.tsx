        ...
        <div className="text-center max-w-5xl text-slate-50 relative z-10">
          <FadeIn direction="up" delay={0.1}>
            <div className="inline-block mb-6 px-4 py-1.5 rounded-full border border-slate-800 bg-slate-900/50 text-xs text-sky-400 uppercase tracking-widest font-semibold">
              Webdesign für Handwerk, Unternehmen & Start-ups aus Münster, NRW und ganz Deutschland
            </div>
          </FadeIn>

          <FadeIn direction="up" delay={0.2}>
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 leading-tight">
              Webdesign, das <span className="text-sky-500">Anfragen, Bewerbungen und Vertrauen</span> bringt.
            </h1>
          </FadeIn>
          ...
          <FadeIn direction="up" delay={0.4}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
              ...
              <Link
                href="#zielgruppen"
                className="w-full sm:w-auto px-8 py-4 rounded-md border border-slate-800 bg-slate-900/50 text-slate-300 font-medium hover:bg-slate-800 hover:text-slate-50 transition-colors"
              >
              ...
              <div>
                ...
                <ul className="space-y-5 mb-8">
                  <li className="flex items-start gap-4">
                    <div className="w-8 h-8 shrink-0 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center font-bold">
                      1
                    </div>
                    <div>
            ...
            <FadeIn direction="left" delay={0.2}>
              <div className="bg-slate-50 rounded-3xl p-10 border border-slate-200 h-full flex flex-col justify-center relative shadow-xl">
                ...
                <div className="flex items-center gap-4 relative z-10">
                  <div className="w-14 h-14 bg-slate-200 rounded-full flex items-center justify-center font-bold text-slate-500 border-2 border-white shadow-sm">
                    JB
                  </div>
                  <div>
                    <p className="font-bold text-slate-900">Justin Boch</p>
                    <p className="text-sm text-slate-500">Gründer & direkter Ansprechpartner</p>
                  </div>
                </div>
              </div>
            </FadeIn>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <FadeIn direction="up" delay={0.1}>
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8 h-full">
                <div className="w-12 h-12 bg-slate-950 border border-slate-800 rounded-xl flex items-center justify-center mb-6 text-sky-500 font-bold">
                  01
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <FadeIn direction="up" delay={0.1}>
              <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl hover:bg-slate-900 transition-colors group h-full flex flex-col">
                <div className="w-12 h-12 bg-slate-950 border border-slate-800 rounded-xl flex items-center justify-center mb-6 text-sky-500 group-hover:scale-110 transition-transform font-bold">
                  01
                </div>
                ...
                <Link href="/de/leistungen" className="text-sky-500 text-sm font-bold flex items-center gap-2 group-hover:text-sky-400">
        ...
        <FadeIn direction="up">
          <div className="w-full max-w-4xl text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/de/kontakt"
                className="inline-block px-10 py-4 rounded-md bg-slate-950 text-sky-500 font-bold text-lg hover:bg-slate-900 transition-all hover:scale-105 shadow-2xl"
              >
