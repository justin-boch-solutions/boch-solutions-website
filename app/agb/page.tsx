      ...
      <div className="max-w-4xl w-full text-slate-300">
        ...
        <FadeIn direction="up">
          <div className="flex items-center gap-4 mb-4">
            <div className="inline-block px-4 py-1.5 rounded-full border border-slate-800 bg-slate-900/50 text-xs text-slate-400 uppercase tracking-widest font-semibold">
              Rechtliches
            </div>
          ...
          <div className="text-lg text-slate-400 mb-12 pb-8 border-b border-slate-800 leading-relaxed">
            <p className="font-bold text-slate-200">Justin Boch Solutions</p>
            <p>Inhaber: Justin Boch</p>
            <p>Königsberger Str. 174</p>
            <p>48157 Münster</p>
            <p>E-Mail: <a href="mailto:kontakt@boch-solutions.de" className="text-blue-400 hover:text-blue-300 transition-colors">kontakt@boch-solutions.de</a></p>
          </div>
        </FadeIn>
        ...
        <FadeIn direction="up" delay={0.1}>
          <div className="space-y-12 leading-relaxed">
            ...
            {/* § 2 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 2 Leistungen des Auftragnehmers</h2>
              <div className="space-y-3">
            ...
            {/* § 5 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 5 Leistungsfristen und Termine</h2>
              <div className="space-y-3">
            ...
            {/* § 6 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 6 Vergütung</h2>
              <div className="space-y-3">
            ...
            {/* § 7 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 7 Korrekturen und Änderungswünsche</h2>
              <div className="space-y-3">
            ...
            {/* § 8 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 8 Abnahme</h2>
              <div className="space-y-3">
            ...
            {/* § 9 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 9 Nutzungsrechte</h2>
              <div className="space-y-3">
            ...
            {/* § 10 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 10 Inhalte und Verantwortung des Auftraggebers</h2>
              <div className="space-y-3">
            ...
            {/* § 11 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 11 Hosting, Domains, Drittanbieter und Fremdleistungen</h2>
              <div className="space-y-3">
            ...
            {/* § 12 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 12 Exit / Offboarding</h2>
              <div className="space-y-3">
            ...
            {/* § 13 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 13 Gewährleistung</h2>
              <div className="space-y-3">
            ...
            {/* § 14 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 14 Haftung</h2>
              <div className="space-y-3">
                ...
                <ul className="list-[lower-alpha] pl-6 space-y-1 text-slate-400">
            ...
            {/* § 15 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 15 Referenznennung</h2>
              <div className="space-y-3">
            ...
            {/* § 16 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 16 Projektunterbrechung, Kündigung und Projektabbruch</h2>
              <div className="space-y-3">
            ...
            {/* § 17 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 17 Vertraulichkeit</h2>
              <div className="space-y-3">
            ...
            {/* § 18 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 18 Datenschutz</h2>
              <div className="space-y-3">
            ...
            {/* § 19 */}
            <section>
              <h2 className="text-2xl font-bold text-slate-50 mb-4">§ 19 Schlussbestimmungen</h2>
              <div className="space-y-3">
