...
const phoneNumber = "4915255703632";
const message =
  "Hallo Justin, ich bin über deine Website auf dich aufmerksam geworden und interessiere mich für eine Website bzw. digitale Lösung für mein Unternehmen. Können wir kurz sprechen?";
  ...
  return (
    <div className="fixed bottom-24 right-6 z-50 flex items-center gap-4 group md:bottom-24 md:right-8">
      ...
      <a
        ...
        className="w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-[0_0_20px_rgba(37,211,102,0.35)] hover:bg-[#20b858] hover:scale-110 transition-all duration-300"
