      ...
      <div className="relative z-10 w-full max-w-5xl text-center px-4 sm:px-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center relative z-10">
            <Link href="/performance-check" className="relative group/btn rounded-full p-[2px] overflow-hidden shadow-[0_0_40px_rgba(14,165,233,0.3)] hover:shadow-[0_0_60px_rgba(14,165,233,0.5)] transition-shadow duration-500">
